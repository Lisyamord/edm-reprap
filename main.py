...
zdownup = 0.35 #миллиетров поднятие-опускание электрода
...
with open(projname + ".gcode", "w") as gout:
    ...
    for x in range(0, width, pixonstep):
        ...
        print("G92 Z5 ; ", file = gout) #новая абсолютная координата в начале строки
